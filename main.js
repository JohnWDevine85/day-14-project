...
**************************************************************************************/
console.log(y) prints: undefined - the function does not run before console.log(y) is requested. It's declared but not run.

console.log(x) prints: "I'm a local variable"
...
console.log(x) prints: "variable hosting!" (after checking, this prints undefined. I thought it would hoist the variable --var x-- above the console.log)
...
first console.log prints: 4
second console.log prints: undefined
...
(function(){
  "use strict";
    var birthday = new Date(1983, 4, 21);
...
(function() {
  ...
  accountCheck();
  //Add properties to 'benefit' using bracket notation
